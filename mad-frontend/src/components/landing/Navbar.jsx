            ...
            >
                <div className="container mx-auto px-4 flex items-center justify-between h-8">
                    ...
                    <div className="flex items-center justify-center md:justify-end gap-4 w-full md:w-auto">
                        ...
                        <Link to="/login" className="hidden md:flex items-center gap-1.5 hover:text-white transition-colors">
            ...
            >
                <div className="flex items-center justify-between max-w-6xl mx-auto">
                    ...
                    <div className="flex items-center gap-2 md:hidden">
                        <Link
                            to="/login"
                            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-bold text-xs transition-all cursor-pointer shadow-sm ${scrolled
                        ...
                        <button
                            ...
                            className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all cursor-pointer ${scrolled
